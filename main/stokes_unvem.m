...
% read mesh
%meshfile = "mesh_tri_338.txt";
%meshfile = "mesh_tri_p_338.txt";
%meshfile = "mesh_quad_324.txt";
%meshfile = "mesh_quad_p_625.txt";
meshfile = "mesh_poly_320.txt";
%meshfile = "mesh_dia_156.txt";
...
parfor ie=1:ne 
    ...
    % main logic
    [A_loc,B1_loc,B2_loc, D_loc,h,F1_loc,F2_loc] = get_MATloc_unvem(mesh.coords(mesh.connect{ie},:),f1,f2);
...
parfor ie=1:ne
    ...
    [dof_U1,dof_U2,dof_P] = el_to_dof(ne,nv,mesh.connect{ie},ie);
    coords = mesh.coords(mesh.connect{ie},:);
    [err0_u_loc, err1_u_loc, err0_p_loc] = get_ERRloc_unvem(coords,SOL(dof_U1),SOL(dof_U2),SOL(dof_P),sol);
...
%h =   4.4322e-02
%Err L2 of p =   3.9646e-01
%Err L2 of u =   4.4621e-03
%Err H1 of u =   5.7121e-01
