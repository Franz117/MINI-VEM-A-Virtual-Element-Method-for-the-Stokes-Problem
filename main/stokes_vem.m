...
% read mesh
%meshfile = "mesh_tri_p_2592.txt";
%meshfile = "mesh_hang_666.txt";
meshfile = "mesh_diam_700.txt";
%meshfile = "mesh_quad_p_1296.txt";
%meshfile = "mesh_poly_2560.txt";
...
X = mesh.coords(:,1);
Y = mesh.coords(:,2);
plot_P(mesh,P,"MiniVEM P",true);
%plot_P_proj(mesh,P,"MiniVEM Projected P",true); 
%plot_P(mesh,p(X,Y),"True P",true);
%plot_P_proj(mesh,P,"Projected",true);
