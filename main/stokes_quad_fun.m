function result = stokes_quad_fun(meshfile)
...
parfor ie=1:ne 
    ...
    % main logic
    [A_loc,B1_loc,B2_loc, D_loc,h] = get_MATloc_quad(mesh.coords(mesh.connect{ie},:));
    [F1_loc,F2_loc] = get_Floc_quad(mesh.coords(mesh.connect{ie},:),f1,f2);
...
parfor ie=1:ne
    ...
    [err0_u_loc, err1_u_loc, err0_p_loc] = get_ERRloc_quad(coords,SOL(dof_U1),SOL(dof_U2),SOL(dof_P),sol);
